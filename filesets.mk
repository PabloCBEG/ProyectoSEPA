...
NEORV32_PERIPH_SRC := \
  $(RTL_CORE_SRC)/../periph/debouncer.vhd \
  $(RTL_CORE_SRC)/../periph/rising_edge_detector.vhd \
  $(RTL_CORE_SRC)/../periph/wb_regs.vhd \
  $(RTL_CORE_SRC)/../periph/controlador_teclado.vhd \
  $(RTL_CORE_SRC)/../periph/controlador_servo.vhd 
...
NEORV32_SRC := ${NEORV32_PKG} ${NEORV32_APP_SRC} ${NEORV32_MEM_ENTITIES} ${NEORV32_MEM_SRC} ${NEORV32_CORE_SRC} ${NEORV32_PERIPH_SRC}
